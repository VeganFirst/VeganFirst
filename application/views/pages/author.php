...
<div class="prof_cat" id="notifications" style="background-image: url(<?php echo base_url();?>assetsNew/img/author-profile.jpg);background-attachment: fixed;
    min-height: 176px;
    background-size: 100%;">
...
<div class="col-md-2 col-sm-2 col-xs-2 mt-60-m">
			<img src="<?php echo base_url();?>media/upload/author/<?php echo $Author->Picture; ?>" class="img-responsive br1" />
		</div>
        <h1 class="homeh1msg mt-60-m" style="color: #fff;"><?php echo $Author->FirstName." ".$Author->LastName; ?></h1> 
        
                        <div class="col-sm-10 decsprof mt-10 mb-10"><?php echo $Author->About; ?></div>
 ...
 <div class="container">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="<?php echo $art;?>"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Article</a></li>
                        <li role="presentation" class="<?php echo $rec;?>"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Recipes</a></li>                      
                    </ul>
               
                <div class="card">
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane <?php echo $art;?>" id="home">
						<div class="row mt-20">
...
?>
                        ...
                        <div role="tabpanel" class="tab-pane <?php echo $rec;?>" id="profile">
                        <div class="row mt-20">
			<?php 
				if(isset($Recipe)) :
					$count=0;
				...
				<div class="modal-body">
					<div class="col-sm-6" style="background: #fff;float: none;margin: 0 auto;padding: 20px; 0">
						...
						<div style="margin: 10px 0;">
							...
							<div class="col-sm-9">
								<h4><a href="<?php echo base_url()?>user/profile/<?php echo $userx->idUser;?>" ><?php echo $userx->Name;?></a></h4>
								<?php echo $userx->city;?>
							</div>
						</div>
						<div class="clearfix"></div>
