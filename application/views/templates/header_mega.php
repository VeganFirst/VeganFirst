...
<link rel="alternate" hreflang="en" href="<?php echo current_url();?>"/>
      ...
      rel="stylesheet">
		...
		<!-- CSS Files -->
		<link href='<?php echo base_url();?>assetsNew/css/bootstrap.min.css?v=1.0.2' rel="stylesheet" />
		<link href='<?php echo base_url();?>assetsNew/css/style.css?v=1.0.29' rel="stylesheet"/>
        ...
        <link href='<?php echo base_url();?>assetsNew/css/aos.css' rel='stylesheet' type='text/css'>
        ...
        <script src="<?php echo base_url()."assetsNew/frontend/"; ?>js/veganfirst.js" type="text/javascript"></script>
         ...
         <script src="<?php echo base_url()."assetsNew/"; ?>js/aos.js?v=1.0.1" type="text/javascript"></script>
        ...
        <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=6041cf08b7dede001191f06c&product=inline-share-buttons' async='async'></script><style>
...
<div class="container-fluid brdbtm " id="menu">
    ...
    <div class="col-sm-12 p-0">
            <div class="hide-sticky">
            	<div class="col-sm-2 ">
                <ul class="list-inline header mt-15">
             ...
             <div class="col-sm-3 mt-20 mb-10">
       ...
       <button type="submit" class="btn btn-success searchpad mt-0 mb-0 z-1"><i class="material-icons">search</i></button>
              ...
              <div class="col-md-3 text-right  mt-10">
							<?php
						...
						<ul class="dropdown-menu pull-right">
								...
								{	?>
                                <button class="btn btn-login mt-0 mb-0 z-1" data-toggle="modal" data-target="#login_popup">Sign In</button>
                                <button class="btn btn-signup mt-0 mb-0 z-1" data-toggle="modal" data-target="#reg_popup">Create an Account</button>
	...
	<div class="container mt-10">
        ...
        <div id="logo">
					<a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assetsNew/img/logo.png" class="img-responsive"></a>
       ...
       <ul class="exo-menu">
                ...
                <!--<li><a href="<?php echo base_url().'starttoday';?>">nutrition plans</a></li> -->
                <li class="mega-drop-down"><a href="#">NEWS</a>
				<div class="animated fadeIn mega-menu container mm1">
					<div class="mega-menu-wrap" style="background: #f2f2f2;">
						<div class="row">
						<div class="col-md-3 pt-10" style="width: 18%;">
						...
						<ul class="stander pl-15">
							<li class="td-menu-item"><a href="#" class="cur-item" data-val="" data-type="article" data-td_id="mm1" data-offset="0">All</a></li>
								...
								<?php $this->load->model("M_Category");
	                                  $this->M_Category = new M_Category();
							        $cats =  $this->M_Category->getAllNavCat();
							        
							        if($cats):
							            foreach($cats as $cat):
							?>
							<li class="td-menu-item"><a href="<?php echo Base_Url().'article/category/'.$cat->Url?>" data-val="<?php echo $cat->id?>" data-type="article" data-td_id="mm1" data-offset="0"><?php echo $cat->CategoryTitle?></a></li>
							<?php endforeach; endif;?>
							
							
						</ul>	
						</div>
						<div class="col-md-9  pb-10" style="border-left: 1px solid #dbdbdb;
    width: 80.6%;
    background: #fff;">
						<div class=" dynamic pt-10"></div>
						<div class="clearfix mb-5"></div>
						<!--<ul class="list-inline col-sm-12 pagin mb-10">
