<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
		...
		?>
                            ...
                            <div class="col-sm-12" style="margin: 10px 0;padding: 0;">
                                <a href="javascript:void(0);" onclick="location.href='<?php echo base_url().'article/'.$Larticl->Url?>'"><img src="<?php echo base_url()."media/upload/article/".$Larticl->FeaturedImage; ?>" class="img-responsive" alt="" style="width:100%;" ></a>										
                            </div>										
                            <div class="col-sm-12" style="padding:0">
                            <p class="headingclssb">
							<a href="javascript:void(0);" onclick="location.href='<?php echo base_url().'article/'.$Larticl->Url?>'"><?php echo $Larticl->PageTitle; ?></a></p>
		...
		?>
                   		 <div class="row rs_toppadder10" style="padding: 0px 15px 0px;">
                            <div class="col-sm-12" style="margin: 10px 0;padding: 0;">
                                <a href="javascript:void(0);" onclick="location.href='<?php echo base_url().'article/'.$Tarticl->Url?>'"><img src="<?php echo base_url()."media/upload/article/".$Tarticl->FeaturedImage; ?>" class="img-responsive" alt="" style="width:100%;" ></a>										
                            </div>										
                            <div class="col-sm-12" style="padding:0">
                            <p  class="headingclssb"><a href="javascript:void(0);" onclick="location.href='<?php echo base_url().'article/'.$Tarticl->Url?>'"><?php echo $Tarticl->PageTitle; ?></a></p>
