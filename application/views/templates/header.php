...
<link rel="alternate" hreflang="en" href="<?php echo current_url();?>"/>
      ...
      rel="stylesheet">
		...
		<link href='<?php echo base_url();?>assetsNew/css/style.css?v=1.0.39' rel="stylesheet"/>
        ...
        <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=6041cf08b7dede001191f06c&product=inline-share-buttons' async='async'></script>
        <style>
...
<div class="container-fluid brdbtm " id="menu">
	...
	<div class="container mt-10">
       ...
       <ul class="exo-menu">
                ...
                <li class="dropdown">
					<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">FOOD <b class="caret"></b></a>
