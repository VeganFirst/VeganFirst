	...
	<div class="main">
		<div class="container">
            ...
            <div class="col-sm-10 mt-60-m p-0">
							...
							<div class="col-sm-6">
								<a href="<?php echo base_url()."user/editProfile/".$User->idUser; ?>">
									<button class="btn btn-warning golink mt-10">EDIT PROFILE</button>
								</a>
							</div>
						</div>
					...
					<div class="row">
						<div class="clearfix"></div>
							...
							<div class="" style="background-color: #f2f6f4;padding: 3% 2% 3% 2%;">                         
								<p class="decshome text-center">You haven't reviewed any restaurant yet</p>
							</div>
							<?php endif ?>
