        ...
        <div id="main" style="margin-left: 0px;">
            ...
            <div class="row-fluid">
                    ...
                    echo "<div class='alert alert-info'><strong>".$Message."</strong></div>";
                                ...
                                <form method="POST" action="<?php echo base_url()?>writer/add_page" class="form-horizontal form-bordered" onSubmit="return validateAdd()" name="page" >
                                    ...
                                    <div id="formErornl"></div>
                                            ...
                                            <div class="form-actions">
                                                    ...
                                                    <a href="<?php echo base_url()."writer/manage_article"; ?>"><button type="button" class="btn">Cancel</button></a>
                                            </div>
                                    </form>
                            </div>
                            </div>
...
console.log(clean);
	...
	/*$('form.formLog').submit( function(form){
		form.preventDefault();
		$.post('/vegan/index.php/writer/add_page',$('form.formLog').serialize(), function(data){
			console.log(data);
