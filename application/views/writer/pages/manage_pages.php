	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Page?");
                if (agree){
                    return true;
                }else{
                    return false;
                                    ...
                                    <div class="span12">
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                    ...
                                                    <h4 class="text-right" style="padding-right: 10px;"><a href="add_page" style="color: #fff;">Add Page</a></h4>
                                            </div>
                                                ...
                                                <table class="table table-hover table-nomargin dataTable table-bordered">
                                                    ...
                                                    if (isset($Pages)){
                                                        foreach ($Pages as $Paged){
                                                            echo "<tr>
                                                                <td>{$Paged->PageTitle}</td>
                                                                <td>{$Paged->Url}</td>
																
                                                                <td class='hidden-480'><a href='".  base_url()."writer/edit_page/{$Paged->id}'>Edit</a> | <a href='".  base_url()."writer/delete_page/{$Paged->id}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
