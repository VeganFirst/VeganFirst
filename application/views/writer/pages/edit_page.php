            ...
            <div class="row-fluid">
                                ...
                                <form method="POST" class="form-horizontal form-bordered formLog" >
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                            <input  type="text"  name="MetaTitle" id="MetaTitle" value="<?php echo $PageInfo->MetaTitle; ?>" placeholder="MetaTitle" class="form-control">
                                                    </div>
                                            </div>
                                            <div class="form-group">
                                                    <label for="MetaKeyword" class="col-sm-2 control-label">MetaKeyword</label>
                                                    <div class="col-sm-10">
                                                            <input  type="text"  name="MetaKeyword" id="MetaKeyword" value="<?php echo $PageInfo->MetaKeyword; ?>" placeholder="MetaKeyword" class="form-control">
                                                    </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <textarea name="MetaDescription" id="MetaDescription" rows="2" maxlength='160' class="form-control"><?php echo $PageInfo->MetaDescription; ?></textarea>
                    ...
                    echo "<div class='alert alert-info'><strong>".$Message."</strong></div>";
                                            ...
                                            <div class="form-actions">
                                                    ...
                                                    <a href="<?php echo base_url()."writer/pages"; ?>"><button type="button" class="btn">Cancel</button></a>
                                            </div>
                                    </form>
                            </div>
                            </div>
...
//		form.preventDefault();
//		$.post('/vegan/index.php/writer/add_article',$('form.formLog').serialize(), function(data){
//			console.log(data);
