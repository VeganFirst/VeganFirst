								...
								<div class="box-content">
									<div class="row-fluid"> 
										...
										<div class="span2 text-center">
											...
											<h4><a href="<?php echo base_url(); ?>writer/manage_author">Authors</a></h4>
											<h4><?php echo count($Authors); ?></h4>
										</div>
										<div class="span2 text-center">
											<i class="icon-user" style="font-size:72px;"></i>
											<h4><a href="<?php echo base_url(); ?>writer/manage_columnist">Columnist</a></h4>
											<h4><?php echo count($Columnist); ?></h4>
										</div>
                                        
                                        <div class="span2 text-center">
											<img src="<?php echo base_url();?>assets/images/article.png" style="max-width: 70px;">
											<h4><a href="<?php echo base_url(); ?>writer/events">Events</a></h4>
											<h4><?php echo count($Events); ?></h4>
										</div>
                                        <div class="span2 text-center">
											<i class="icon-food" style="font-size:72px;"></i>
											<h4><a href="<?php echo base_url(); ?>writer/manage_recipes">Recipes</a></h4>
											<h4><?php echo count($Recipe); ?></h4>
										</div>
										<div class="span2 text-center">
											<img src="<?php echo base_url();?>assets/images/restaurant.png" style="max-width: 70px;">
											<h4><a href="<?php echo base_url(); ?>writer/manage_restaurant">Restaurant</a></h4>
										...
										<div class="span2 text-center">
											<img src="<?php echo base_url();?>assets/images/article.png" style="max-width: 70px;">
											<h4><a href="<?php echo base_url(); ?>writer/manage_article">Article</a></h4>
