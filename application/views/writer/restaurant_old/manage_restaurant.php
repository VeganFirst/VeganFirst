...
<body>
	...
	<div class="container-fluid" id="content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
                                  ...
                                  <th width="30px;">Id</th>
                                   ...
                                   <th width="30px;">Restaurant Image</th>

                                   <th>Restaurant Name</th>

                                   <th width="20px;">is Premium</th>
                                   ...
                                   <th width="20px;" class='hidden-480'>Published</th>

                                    <th width="100px;" class='hidden-480'>Actions</th>
		   ...
		   <td class='hidden-480'><a href='".  base_url()."restaurant/{$Article->Url}' target='_blank'>View</a> | <a href='".  base_url()."writer/edit_restaurant/{$Article->idRestaurant}'>Edit</a></td>
