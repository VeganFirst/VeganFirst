...
<body>
 <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Publisher?");
                if (agree){
                    return true;
                }else{
                    return false;
                                        ...
                                        <div class="box box-color box-bordered">
                                            ...
                                            <div class="box-content nopadding">
												...
												if($Writer->isActive==1)
                                                   ...
                                                   <td>{$Writer->Phone}</td>
												   <td>{$status}</td>
                                                   <td class='hidden-480'><a href='".  base_url()."writer/edit_writer/{$Writer->id}'>Edit</a> | <a href='".  base_url()."writer/delete_writer/{$Writer->id}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
