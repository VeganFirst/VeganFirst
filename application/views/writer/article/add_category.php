            ...
            <div class="row-fluid">
                    <div class="span12">
                            ...
                            <div class="box-content">
                                <form  action="<?php echo base_url()?>writer/add_article_cat" method="POST" class="form-horizontal form-bordered formLog" enctype="multipart/form-data">
...
console.log(clean);
	...
	/*$('form.formLog').submit( function(form){
		form.preventDefault();
		$.post('/vegan/index.php/writer/add_article_cat',$('form.formLog').serialize(), function(data){
			console.log(data);
