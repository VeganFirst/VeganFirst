	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Products?");
                if (agree){
                    return true;
                }else{
                    return false;
                                    ...
                                    <div class="span12">
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                    ...
                                                    <h4 class="text-right" style="padding-right: 10px;"><a href="add_products" style="color: #fff;">Add Product</a></h4>
                                            </div>
                                                    ...
                                                    <thead>
                                                        ...
                                                        <th>Product Image</th>
                                                            ...
                                                            <th>Category</th>
                                                             ...
                                                             <th class='hidden-480'>Featured</th>
								...
								$this->M_Category = new M_Category();						
                                                    if (isset($Articles)){
                                                        foreach ($Articles as $Article){
															$status="Disable";
															$featured ='No' ;
															$iurl= base_url()."media/upload/products/";
																
$cat=$this->M_Category->getCategoryInfo($Article->Category);
if($Article->Featured==1){ $featured ='Yes' ;}
if($Article->isActive==1){ $status ='Active';}

                                                            echo "<tr>
															<td> <img src='$iurl$Article->FeaturedImage' class='img-responsive' style='max-width: 50px;'> </td>
                                                                <td>{$Article->PageTitle}</td>
                                              <td>{$cat->PageTitle}</td>
											   <td>{$featured}</td>                                             <td class='hidden-480'>{$featured}</td>
																
                                                                <td class='hidden-480'><a href='".  base_url()."product/{$Article->Url}' target='_blank'>View</a> | <a href='".  base_url()."writer/edit_products/{$Article->idProduct}'>Edit</a> | <a href='".  base_url()."writer/delete_products/{$Article->idProduct}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
