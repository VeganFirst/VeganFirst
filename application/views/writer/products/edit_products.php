                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                            <select name="Featured" title="Featured" id="Featured" class="form-control" >
                                                             ...
                                                             <option value="1" <?php if($ProductInfo->isActive==1): echo "selected"; endif; ?>>Active</option>
                                                             <option value="0" <?php if($ProductInfo->isActive==0): echo "selected"; endif; ?>>InActive</option>
                                                            </select>
                                                    </div>
                                            </div>
