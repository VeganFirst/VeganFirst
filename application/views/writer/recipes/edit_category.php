                            ...
                            <div class="box-content">
                                <form  action="#" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input required type="text" value="<?php echo $AuthorInfo->CategoryTitle; ?>" name="CategoryTitle" id="PageTitle" placeholder="Author First Name" class="form-control">
                                                    </div>
                                            </div>
                                        
                                           <div class="form-group">
                                                <label for="isActive" class="col-sm-2 control-label">Author Account status </label>
                                                    <div class="col-sm-10">
