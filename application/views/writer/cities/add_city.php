...
<form  action="#" method="POST" class="form-horizontal form-bordered" onSubmit="return validateAdd()" name="page">
 ...
 <div class="form-group">
      ...
      <div class="col-sm-10">
         <input type="text" value="" name="name" id="PageTitle" placeholder="City Title" class="form-control">
      </div>
 </div>
  ...
  <div class="form-group">
      <label for="PageTitle" class="col-sm-2 control-label">City URL</label>
       <div class="col-sm-10">
       <input type="text" value="" name="url" id="Url" placeholder="City Url" class="form-control">
       </div>
  </div>
