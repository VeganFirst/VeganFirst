	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
		<script>
			function confirmDelete(){
				var agree = confirm("Are you sure to delete this City?");
				if (agree){
					return true;
				}else{
					return false;
						...
						<div class="box box-color box-bordered">
							<div class="box-title">
								...
								<div class="pull-right"  style="margin-right: 2%">
									<a href="<?php echo base_url().'writer/add_city'; ?>">
							...
							<div class="box-content nopadding table-responsive ">
							  ...
							  <td>{$City->url}</td>
							  <td>{$status}</td>
							  <td class='hidden-480'><a href='".  base_url()."writer/edit_city/{$City->id}'>Edit</a> | <a href='".  base_url()."writer/delete_city/{$City->id}' onclick='return confirmDelete();'>Delete</a></td>
														</tr>";
														}
													}
													?>
