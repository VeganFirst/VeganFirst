...
if($this->M_Recipes->isMysaveRecipe($Recipe->idRecepie)){	$savecl='art_saved'; $un='un';  } ?>
					<li><a href="javascript:void(0);"><i class="icon-bookmark <?php echo $savecl;?>" id="bookm<?php echo $Recipe->idRecepie;?>"  onclick="<?php echo $un;?>SaveRecipe(<?php echo $Recipe->idRecepie;?>)"></i></a></li> 
                        ...
                        <div class="decshome row mt-10 mb-20">
                              ...
                              <div class="col-sm-4 col-xs-4 recp_prep text-center">
                              <img src="<?php echo base_url().'assetsNew/img/clock.png'?>" class="center-block" />
                              <p class="titlercp">Prep Time</p>
                              <p class="tme"><?php echo $Recipe->PrepTime; ?></p>                               </div>
                              
                              <div class="col-sm-4 col-xs-4 recp_prep text-center">
                              <img src="<?php echo base_url().'assetsNew/img/clock.png'?>" class="center-block" />
                              <p class="titlercp">Cook Time</p>
                              <p class="tme"><?php echo $Recipe->CookTime; ?></p>                               </div>
                              
                              <div class="col-sm-4 col-xs-4 recp_prep text-center">
                              <img src="<?php echo base_url().'assetsNew/img/clock.png'?>" class="center-block" />
                              <p class="titlercp">Total Time</p>
                              <p class="tme"><?php echo $Recipe->ReadyIn; ?></p>                               </div>
