						...
						<div>
							...
							<div class="col-sm-12 mt-30">
								<ul class="list-inline expline">
									<li><span class="expname2">Address</span><br><span class="expname"><?php echo $Restaurant->City.', '.$Restaurant->Country; ?></span></li>
									<li class="pull-right"><i class="fa fa-map-marker rest_icon" aria-hidden="true"></i></li>
								</ul>
								<ul class="list-inline expline">
...
<!--slider-->
	...
	<a href="<?php echo base_url().'media/upload/restaurant/photo/'.$Image->file_name; ?>" class="big" style="display:none;">
						...
						<?php else: ?>
							<div class="">                         
								<p class="decshome text-center">Restaurant didnt Reviewed yet</p>
							</div>
						<?php endif ?>
