...
<style type="text/css">
   ...
   <div class="row">
        <div class="col-xs-4 col-xs-offset-1 p-0">
			...
			<img src="<?php echo base_url().'media/upload/user/'.$User->ProfilePic; ?>" class="img-responsive mt-60-m br1">
			<?php else: ?>
...
<div class="clearfix"></div>   
	<div class="main">
		...
		<div class="clearfix"></div>
		<button style="width: 100%;" type="submit" class="btn btn-gwhite expbtn" onclick="location.href='<?php echo base_url().'user/editProfile/'.$User->idUser;;?>'">EDIT PROFILE</button>
        <div class="clearfix"></div>
    
    <h4 class="mt-10"> <a href="<?php echo base_url();?>user/message" class="title1 "><i class="fa fa-envelope" aria-hidden="true"></i> Messages</a></h4>
	...
	<?php endforeach ?>
	<?php else: ?>
	<div class="" style="background-color: #f2f6f4;padding: 3% 2% 3% 2%;"> 	<p class="decshome text-center">You haven't reviewed any restaurant yet</p>
	</div>
	<?php endif; ?>
	<div class="mt-30">
	<a href="<?php echo base_url()."restaurants"; ?>"><button class="btn btn-success coolbtn" style="letter-spacing:1px;">SEE OUR LIST OF RESTAURANTS</button></a>
	</div>
	...
	<h4 class="title1 mt-30">My Bookmark</h4>
    <div class="row">
    ...
    $Article=$this->M_Article->getArticleInfo($article->idSave);
            ...
            <?php endif;?>
                      ...
                      ?></span></li>
								...
								<li>
									<a href="javascript:void(0);" onclick="unSaveArticle(<?php echo $Article->idArticle;?>)">
										<i class="icon-bookmark art_saved" id="bookm<?php echo $Article->idArticle;?>"></i>
									</a>
								</li>
                                        </ul>
                                    </div>
