...
<div class="container text-center mt-0 mb-30 pb-10 pt-10" style="background:#e6e6e6;background: url(assetsNew/img/Starter-Kit-Banner.png);background-size: cover;">
  <div class="col-md-6 col-md-offset-6">
<h2 class="mt-10 homettl" data-aos="fade-up"  data-aos-easing="linear">Start Your Vegan Journey Today</h2>
...
<button class="btn btn-success mb-10 mt-15" data-aos="fade-up" data-aos-delay="250" data-aos-easing="linear" style="box-shadow: none;border-radius: 0;font-size: 16px;letter-spacing: 0.8px;" data-toggle="modal" data-target="#download_skit">Download Free Starter Kit</button>
</div>  
...
<div class="form-inline mt-30" data-aos="fade-up" data-aos-delay="450" data-aos-easing="linear">
 ...
 ?>
  <div class=" mt-50 pt-30 pb-30" data-aos="fade-up" data-aos-delay="50" data-aos-easing="linear" style="background:#6cbd45">
