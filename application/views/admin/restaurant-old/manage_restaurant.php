...
<body>
	...
	<div class="container-fluid" id="content">
		   ...
		   <td>{$Article->Views}</td>
                                                                                            <td>{$status}</td>
		   <td><a href='".  base_url()."restaurant/{$Article->Url}' target='_blank'>View</a> | <a href='".  base_url()."admin/edit_restaurant/{$Article->idRestaurant}'>Edit</a> | <a href='".  base_url()."admin/delete_restaurant/{$Article->idRestaurant}' onclick='return confirmDelete();'>Delete</a></td>
           </tr>";
           }
       }
  ?>
