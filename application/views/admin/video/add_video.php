					...
					<div class="row-fluid">
						<div class="span12">
							<div class="box box-bordered box-color">
								<div class="box-title">
									<h3><i class="icon-th-list"></i> Video Details</h3>
								</div>
								<div class="box-content">
									...
									<form method="POST" class="form-horizontal form-bordered formLog" enctype="multipart/form-data" onSubmit="return validateAdd()" name="page">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text"  name="PageTitle" id="Title" placeholder="Video Title" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label for="URL" class="col-sm-2 control-label">URL</label>
											<div class="col-sm-10">
												<input  type="text"  name="Url" id="Url" placeholder="Video Url" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<select name="category" title="Category" id="Category" class="form-control" >
													...
													if(isset($Category))
													{
														...
														{ ?>
														<option value="<?php echo $Cat->id; ?> "><?php echo $Cat->CategoryTitle; ?></option>
													<?php   }
													}
													?>
												</select>
										...
										<div class="form-group">
											<label for="message-text" class="col-sm-2 control-label">Video Embed Link:</label>
											<div class="col-sm-10">
												<input type="text" name="videoURL" id="videoURL" placeholder="Video Embed Link" class="form-control">
											</div>
										</div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-10">
												<img src="<?php echo base_url();?>assets/img/demo/2.jpg" alt="Blank image" onClick="$('#file').click();" id="uploadimg" class="img-thumbnail">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input  type="text"  name="Tags" id="Tags"  placeholder="Tags, Tags2" class="form-control">
											</div>
										</div>
										<div class="form-group">
