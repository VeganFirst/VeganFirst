	...
	<div class="container-fluid" id="content">
                                        ...
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                 <div class="span11">
                                                    ...
                                                    <div class="span1">
                                                    <a href="<?php echo Base_Url().'admin/add_article_sub_cat/'.$this->uri->segment(3)?>"><button class="btn btn-primary">Add New</button></a>
                                                    </div>
          ...
          if (isset($Articles)){
           foreach ($Articles as $Article){
			...
			$count=$this->M_Article->getSubCategoryCount($Article->id);
            echo "<tr>
                  ...
                  <td><a href='".  base_url()."admin/edit_article_sub_cat/{$this->uri->segment(3)}/{$Article->id}'>Edit</a> | <a href='".  base_url()."admin/delete_article_sub_cat/{$this->uri->segment(3)}/{$Article->id}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
