            ...
            <div class="row-fluid">
                    <div class="span12">
                            ...
                            <div class="box-content">
                                <form  action="<?php echo base_url()?>admin/add_article_cat" method="POST" class="form-horizontal form-bordered formLog" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label for="isActive" class="col-sm-2 control-label">Display Order </label>
                                                    <div class="col-sm-10">
                                                           <input type="number" name="disp_order" class="form-control" min=0 value="0">
                                                    </div>
                                            </div>
...
console.log(clean);
	...
	/*$('form.formLog').submit( function(form){
		form.preventDefault();
		$.post('/vegan/index.php/admin/add_article_cat',$('form.formLog').serialize(), function(data){
			console.log(data);
