                                ...
                                <form  action="#" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                           ...
                                           <div class="form-group ">
                                            ...
                                            <div class="form-group">
                                                <label for="isActive" class="col-sm-2 control-label">Display Order </label>
                                                    <div class="col-sm-10">
                                                           <input type="number" name="disp_order" class="form-control" min=0 value="<?php echo $AuthorInfo->disp_order; ?>">
                                                    </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="isActive" class="col-sm-2 control-label">Display in Navigation </label>
                                                    <div class="col-sm-10">
                                                         <select required name="show_nav" id="show_nav" class="form-control">
                                            
                                                            
                                                                <option value="1" <?php if ($AuthorInfo->show_nav==1){echo "selected";} ?>>Yes</option>
                                                                <option value="0" <?php if ($AuthorInfo->show_nav==0){echo "selected";} ?>>NO</option>
                                                            </select>
                                           ...
                                           <?php /* <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                    <label for="MetaTitle" class="col-sm-2 control-label">Editorials Pics</label>
                                                    <div class="col-sm-10">
                                                            <input  type="text"  name="editorials" id="editorials" value="<?php echo $AuthorInfo->editorials; ?>"  placeholder="Editorials Pics Max 4 saparated by ," class="form-control"> Editorials Max 4 saparated by ,
                                                    </div>
                                            </div>
                                            <div class="form-group">
