	...
	<script src="<?php echo base_url()."assets/"; ?>js/eakroko.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Testimonial?");
                if (agree){
                    return true;
                }else{
                    return false;
                                    ...
                                    <div class="span12">
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                    ...
                                                    <h4 class="text-right" style="padding-right: 10px;"><a href="add_testim" style="color: #fff;">Add Testimonial</a></h4>
                                            </div>
                                            <div class="box-content nopadding">
                                                <table class="table table-hover table-nomargin dataTable table-bordered">
                                                    <thead>
                                                        <tr>
                                                        <th width="30">Id</th>
                                                        <th width="180">Testimonial By</th>
                                                    ...
                                                    if (isset($Testis)){
                                                        foreach ($Testis as $testi){
															...
															<td>{$testi->idTesti}</td>
                                                                <td>{$testi->name_user}</td>
																<td><img src='".  base_url()."media/upload/testi/{$testi->image_user}'</td>
																
                                                                <td>{$testi->content}</td>
																<td>{$status}</td>
																<td>{$testi->updated_on}</td>
																
                                                                <td><a href='".  base_url()."admin/edit_testim/{$testi->idTesti}'>Edit</a> | <a href='".  base_url()."admin/delete_testim/{$testi->idTesti}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
