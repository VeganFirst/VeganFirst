	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Question?");
                if (agree){
                    return true;
                }else{
                    return false;
                                                    ...
                                                    if (isset($Authors)){
                                                        foreach ($Authors as $Article){
                                                            echo "<tr>
                                                                ...
                                                                <td><a href='".  base_url()."admin/edit_question/{$Article->idQuestion}'>Edit</a> | <a href='".  base_url()."admin/delete_question/{$Article->idQuestion}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
