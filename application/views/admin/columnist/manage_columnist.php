	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Columnist?");
                if (agree){
                    return true;
                }else{
                    return false;
                                                    ...
                                                    if (isset($Authors)){
														...
														$status ="Inactive";	
														    ...
														    echo "<tr>
																...
																<td>{$status}</td>
                                                                <td><a href='".  base_url()."admin/edit_columnist/{$Writer->idColumnist}'>Edit</a> | <a href='".  base_url()."admin/delete_columnist/{$Writer->idColumnist}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
