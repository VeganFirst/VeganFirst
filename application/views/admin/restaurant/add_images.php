...
<div class=" col-sm-3">
<a href="<?php echo base_url().'admin/delete_restaurant_image/'.$Image->id.'/'.$Image->restaurant_id?>" onclick='return confirmDelete();' style="position: absolute;top: 7px;left: 22px;"><i class="icon-remove-sign icon-2x" style="color:#55ba47;"></i></a>
