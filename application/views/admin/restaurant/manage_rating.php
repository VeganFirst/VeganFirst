	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Review?");
                if (agree){
                    return true;
                }else{
                    return false;
...
<body>
	...
	<div class="container-fluid" id="content">
		   ...
		   <td><a href='". base_url()."restaurants/{$Article->Url}' target='_blank'>View</a> | <a href='".  base_url()."admin/delete_rating/{$Article->id}' onclick='return confirmDelete();'>Delete</a></td>
           </tr>";
           }
       }
  ?>
