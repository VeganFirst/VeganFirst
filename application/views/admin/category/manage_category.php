	...
	<div class="container-fluid" id="content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
                                    <div class="span12">
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                    ...
                                                    <h4 class="text-right" style="padding-right: 10px;"><a href="add_category" style="color: #fff;">Add Category</a></h4>
                                            </div>
							...
							<td>{$count}</td>
							<td>{$status}</td>
							<td><a href='".  base_url()."admin/edit_category/{$Article->id}'>Edit</a> | <a href='".  base_url()."admin/delete_category/{$Article->id}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
