	...
	<script src="<?php echo base_url()."assets/"; ?>js/eakroko.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Plan?");
                if (agree){
                    return true;
                }else{
                    return false;
                                    ...
                                    <div class="span12">
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                    ...
                                                    <h4 class="text-right" style="padding-right: 10px;"><a href="add_plan" style="color: #fff;">Add Plan</a></h4>
                                            </div>
                                            <div class="box-content nopadding">
                                                <table class="table table-hover table-nomargin dataTable table-bordered">
                                                    <thead>
                                                        <tr>
                                                        <th width="30">Plan Id</th>
                                                        <th>Plan Name</th>
                                                        <th>Plan Tagline</th>
                                                        <th width="120">Price(Per Month)</th>
                                                        <th width="80">Tenure Month</th>
                                                    ...
                                                    if (isset($Plans)){
                                                        foreach ($Plans as $plan){
															...
															<td>{$plan->idPlan}</td>
                                                                ...
                                                                <td>INR {$plan->monthly_price}</td>
																<td>{$plan->month_tenure}</td>
																<td>{$plan->updated_on}</td>
																
                                                                <td><a href='".  base_url()."admin/edit_plan/{$plan->idPlan}'>Edit</a> | <a href='".  base_url()."admin/delete_plan/{$plan->idPlan}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
