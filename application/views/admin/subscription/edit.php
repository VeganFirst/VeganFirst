        ...
        <div id="main" style="margin-left: 0px;">
            ...
            <div class="row-fluid">
                    <div class="span12">
                            ...
                            <div class="box-title">
                                    <h3><i class="icon-th-list"></i> Edit Plan</h3>
                            </div>
                            <div class="box-content">
                            <?php    if (isset($Message)){
                    echo "<div class='alert alert-info'><strong>".$Message."</strong></div>";
                } ?>
                <form method="POST" class="form-horizontal form-bordered" onSubmit="return validateAdd()" name="page" enctype="multipart/form-data" >
                <div class="form-group">
                  <label for="Title" class="col-sm-2 control-label">Plan Title</label>
                  <div class="col-sm-10">
                  <input type="text"  name="title" id="Title" placeholder="Plan Title" class="form-control" value="<?php echo $Plan->title?>">
                   </div>
                </div>
                <div class="form-group">
                  <label for="tagline" class="col-sm-2 control-label">Plan Tagline</label>
                  <div class="col-sm-10">
                  <input type="text"  name="tagline" id="tagline" placeholder="Plan Tagline" class="form-control" value="<?php echo $Plan->tagline?>">
                   </div>
                </div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text"  name="monthly_price" id="Phone" placeholder="Monthly Price INR" class="form-control" value="<?php echo $Plan->monthly_price?>">
					</div>
					<div class="col-sm-2">
						<input type="text"  name="month_tenure" id="Time" placeholder="Month Tenure" class="form-control" value="<?php echo $Plan->month_tenure?>">
					</div>
					<div class="col-sm-2">
						<input type="text"  name="position" id="Delivery" placeholder="Display Order" class="form-control" value="<?php echo $Plan->position?>">
					</div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text"  name="price_line" id="Title" placeholder="Price Tagline(INR 100 monthly per annum)" class="form-control" value="<?php echo $Plan->price_line?>">
                   </div>
                </div>
                <div class="form-group">
                    ...
                    <img src="<?php echo base_url().'media/plan/'.$Plan->image_name;?>" alt="Blank image" id="uploadimg" class="img-thumbnail">
               		<?php endif;?>
                ...
                <div class="form-group">
                   <label for="Description" class="col-sm-2 control-label">Plan Options Points</label>
                    <div class="col-sm-10">
                    	<textarea id="editor1" name="points" ><?php echo $Plan->points?></textarea> 
                    </div>
				</div>
