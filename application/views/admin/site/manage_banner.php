	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Banner?");
                if (agree){
                    return true;
                }else{
                    return false;
	...
	<div class="container-fluid" id="content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
                    ...
                    <a href="addbanner" style="color: #fff;">Add New</a>
                    </h4>
           ...
           echo "<tr>
		   <td>{$Banner->id}</td>
		   <td> <img src='$iurl$Banner->imagename' class='img-responsive' style='max-width: 300px;'> </td>
           
		   <td>{$status}</td>

		   <td>{$Banner->updated}</td>
		   <td><a href='".  base_url()."admin/editbanner/{$Banner->id}'>Edit</a> | <a href='".  base_url()."admin/deletebanner/{$Banner->id}' onclick='return confirmDelete();'>Delete</a></td>
           </tr>";
           }
       }
  ?>
