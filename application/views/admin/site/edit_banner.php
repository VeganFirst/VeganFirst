...
<div class="form-group">
	...
	<div class="col-sm-10">
	<input type="text"  name="title" id="Title" placeholder="Banner Title" class="form-control" value="<?php echo $Banner->title?>">
	</div>
</div>
<div class="form-group">
<label for="Password" class="col-sm-2 control-label">Short Description</label>
	<div class="col-sm-10">
	<textarea name="descr" class="form-control" rows="3"><?php echo $Banner->descr?></textarea> 
	</div>
</div>
<div class="form-group">
	<label for="URL" class="col-sm-2 control-label">Button Title</label>
	<div class="col-sm-10">
	<input  type="text"  name="button_title" id="Bttl" placeholder="Button Title" class="form-control" value="<?php echo $Banner->button_title?>">
	</div>
</div>
<div class="form-group">
	<label for="URL" class="col-sm-2 control-label">URL</label>
	<div class="col-sm-10">
	<input  type="text"  name="url" id="Url" placeholder="Link Url" class="form-control" value="<?php echo $Banner->url?>">
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-10">
    <?php if($Banner->imagename):?>
    <img src="<?php echo Base_Url().'media/banner/'.$Banner->imagename?>" alt="Blank image" id="uploadimg" class="img-thumbnail" style="max-width:500px">
    <?php else:?>
