             ...
             <div class="box box-bordered box-color">
                ...
                <div class="box-content">
 							...
 							foreach($Config as $key => $val)
							{
							 ...
							 if($val->path == 'Recipe/catH')
							 {
								$Prod7= $val->addBlock;
							 }

							 if($val->path == 'Recipe/cat')
							 {
								$Prod8= $val->addBlock;
							 }
							 if($val->path == 'Recipe/view')
							 {
								$Prod9= $val->addBlock;
							 }
							 ...
							 if($val->path == 'Home/top')
							 {
								$Prod13= $val->addBlock;
							 }
							 
							 if($val->path == 'Mobile/top')
							 {
								$Prod14= $val->addBlock;
							 }
...
<div class="form-group">
      <label for="Article" class="col-sm-2 control-label">Home Page Top Adv </label>
      <div class="col-sm-10">
       <textarea id="editor13" name="Home/top" ><?php echo $Prod13; ?></textarea> 
       1350 X 300 or more
       </div>
</div>
...
<div class="form-group">
      <label for="Article" class="col-sm-2 control-label">Home Mobile Top Adv</label>
      <div class="col-sm-10">
       <textarea id="editor14" name="Mobile/top" ><?php echo $Prod14; ?></textarea> 
       500 X 380 or more
      </div>
</div>
...
CKFinder.setupCKEditor( editor, '../' );
var editor = CKEDITOR.replace( 'editor13', {
    filebrowserBrowseUrl :  '<?php echo base_url()."assets/editor/"; ?>ckfinder/ckfinder.html',
    filebrowserImageBrowseUrl : '<?php echo base_url()."assets/editor/"; ?>ckfinder/ckfinder.html?type=Images',
...
CKFinder.setupCKEditor( editor, '../' );
var editor = CKEDITOR.replace( 'editor14', {
    filebrowserBrowseUrl :  '<?php echo base_url()."assets/editor/"; ?>ckfinder/ckfinder.html',
    filebrowserImageBrowseUrl : '<?php echo base_url()."assets/editor/"; ?>ckfinder/ckfinder.html?type=Images',
