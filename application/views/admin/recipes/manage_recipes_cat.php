...
<body>
	...
	<div class="container-fluid" id="content">
                                    ...
                                    <div class="span12">
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                    ...
                                                    <h4 class="text-right" style="padding-right: 10px;"><a href="add_category_rec" style="color: #fff;">Add New Category</a></h4>
                                            </div>
			...
			$count=$this->M_Recipes->getCategoryCount($Article->id);
                  echo "<tr>
				 ...
				 <td>{$Article->Views}</td>
				 <td>{$status}</td>
				 <td><a href='".  base_url()."admin/edit_category_rec/{$Article->id}'>Edit</a> | <a href='".  base_url()."admin/delete_category_rec/{$Article->id}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
