                                                    ...
                                                    if (isset($Pages)){
                                                        foreach ($Pages as $Paged){
															...
															<td>{$Paged->idevent}</td>
                                                                ...
                                                                <td>{$Paged->event_url}</td>
                                                                <td>{$Paged->event_date} {$Paged->event_time}</td>
																<td>{$Paged->Views}</td>
																
																
                                                                <td><a href='".  base_url()."admin/edit_event/{$Paged->idevent}'>Edit</a> | <a href='".  base_url()."admin/delete_event/{$Paged->idevent}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
