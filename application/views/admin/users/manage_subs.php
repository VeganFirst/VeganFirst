	...
	<script src="<?php echo base_url()."assets/"; ?>js/application.min.js"></script>
        <script>
            function confirmDelete(){
                var agree = confirm("Are you sure to delete this Subscriber?");
                if (agree){
                    return true;
                }else{
                    return false;
	...
	<div class="container-fluid" id="content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
                                        ...
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                    ...
                                                    <h3 class="pull-right" style="margin-right:20px;">
                                                         <a href="<?php echo base_url().'admin/ExportCSV'?>">  <i class="icon-download-alt"></i>Export Csv</a>
                                                    </h3>
                                            </div>
							...
							$Ldate = new DateTime($Writer->subOn);
                                                        $subf= "";
                                                        if($Writer->type_id==0)
                                                        {  $subf= "Both";}
                                                       if($Writer->type_id==1)
