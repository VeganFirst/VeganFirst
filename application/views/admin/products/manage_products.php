...
if($Article->Featured==1){ $featured ='Yes' ;} else{$featured ='No' ;}
if($Article->isPublished==1){ $status ='Yes';}else{$status ='No';}

                                                            echo "<tr>
															<td> <img src='$iurl$Article->FeaturedImage' class='img-responsive' style='max-width: 50px;'> </td>
                                                                <td>{$Article->PageTitle}</td>
                                              <td>{$cat->PageTitle}</td>
											   <td>{$status}</td>                                             <td>{$featured}</td>
																
                                                                <td><a href='".  base_url()."product/{$Article->Url}' target='_blank'>View</a> | <a href='".  base_url()."admin/edit_products/{$Article->idProduct}'>Edit</a> | <a href='".  base_url()."admin/delete_products/{$Article->idProduct}' onclick='return confirmDelete();'>Delete</a></td>
                                                        </tr>";
                                                        }
                                                    }
                                                    ?>
