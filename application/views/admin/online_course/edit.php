        ...
        <div id="main" style="margin-left: 0px;">
            ...
            <div class="row-fluid">
                    <div class="span12">
                            ...
                            <div class="box-title">
                                    <h3><i class="icon-th-list"></i> Edit Course</h3>
                            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input type="text"  name="course_name" id="Title" placeholder="Course Title" class="form-control" value="<?php echo $Course->course_name ?>">
                   </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <img src="<?php echo Base_Url().'media/upload/course/'.$Course->course_image?>" style="max-width:400px"><br/><br/>
                    <?php endif; ?>
                ...
                <div class="form-group">
                   <label for="Description" class="col-sm-2 control-label">Email Template</label>
                    <div class="col-sm-10">
                    	<textarea id="editor1" name="emil_info" ><?php echo $Course->emil_info ?></textarea> 
                    </div>
				</div>
